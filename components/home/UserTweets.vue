<template>
    <section class="px-4 lg:px-0 lg:pl-16 pb-16 dark:bg-dark-900 ">
        <div
            class="bg-secondary dark:bg-dark-700 dark:shadow-2xl p-10 lg:pl-16  xl:rounded-bl-3xl flex flex-col lg:flex-row gap-x-28 gap-y-10">
