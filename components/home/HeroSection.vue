<template>
    <section
        class="bg-[#F8FAFC] dark:bg-secondary/95 py-16 md:py-32 xl:py-0  xl:h-[70vh] flex items-center justify-center flex-col">
        <div class="w-11/12 lg:w-9/12 mx-auto  text-center">
            ...
            <p
                class="text-[#475569] dark:text-white/80 text-sm lg:text-[1.312rem] w-11/12 lg:w-9/12 mx-auto mt-4 md:mt-9 lg:mt-12 ">
                Lorem
                Ipsum is
                simply
                dummy text
            ...
            <form class="mt-16 md:mt-9 lg:mt-12 flex gap-x-10 gap-y-3 justify-center flex-col md:flex-row">
                <select
                    class="border border-primary outline-0 px-6 lg:px-10 py-3 lg:py-4 text-[#475569] dark:text-white/80 bg-[#C4C4C4]/5 text-left">
                    <option>Choose your major</option>
                    <option v-for="(             major, index             ) in              majors            "
