<template>
    <section class="bg-[#F8FAFC] py-16 md:py-32 xl:py-0  xl:h-[70vh] flex items-center justify-center flex-col">
        <div class="w-11/12 lg:w-9/12 mx-auto  text-center">
            <h1 class="text-2xl md:text-4xl lg:text-7xl font-black">
            ...
            <p class="text-[#475569] text-sm lg:text-[1.312rem] w-11/12 lg:w-9/12 mx-auto mt-4 md:mt-9 lg:mt-12 ">Lorem
                Ipsum is
                simply
                dummy text
                of the
