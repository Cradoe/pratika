<template>
    <div>
        ...
        <div class="flex items-center justify-center  ">
            <div class="max-w-xl w-full px-4 sm:px-6 lg:p-24 border border-[#E5E5E5] mb-24">
                ...
                <form action="#" method="POST" @submit.prevent=" handleSubmit ">
                    <div class="pb-5">
                        ...
                        <div v-show=" submitted && !email " class="text-red-400 text-xs">Email address is required</div>
                    </div>
                    <div class="py-4">
                        ...
                        <div v-show=" submitted && !password " class="text-red-400 text-xs">Password is required</div>
                    </div>
                    ...
                    <div class="mt-10">
                        <Button class="mx-auto" :disabled=" status.loggingIn ">
                            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                <fa :icon=" [ 'fas', 'lock' ] "
                                    class="h-5 w-5 text-primary/80 group-hover:text-secondary/50" aria-hidden="true" />
                            </span>
                            Sign in
                        </Button>
                    </div>
